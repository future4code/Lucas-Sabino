...
/*3.let p = prompt("Quantas horas você trabalha por dia?")
    ...
    //Desafio
    let x = Number(prompt("Primeiro número do desafio"))
    let y = Number(prompt("Segundo número do desafio"))
    let z = undefined
    ...
    z = x * y
    console.log("O primeiro número multiplicado ao segundo número resulta em:",z)