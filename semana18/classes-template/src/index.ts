...
/*
a) O construtor é um método da classe, que serve para criar, atualizar e inicializar um objeto criado a partir de uma classe.
...
const newUser = new UserAccount("01234567891", "Lucas", 12)
// Apenas uma vez.
